...
(defonce talks
  {:rooms
   ...
   [{:date     "2020-02-14",
     ...
     :start_at "2020-02-14T09:30:00+05:30"}
    {:date     "2020-02-15",
     :end_at   "2020-02-15T19:00:00+05:30",
     :slots
     [{:sessions
       [{:description  {:html "", :text ""},
         :timezone     "Asia/Kolkata",
         ...
         :end_at       "2020-02-15T09:30:00+05:30",
         :feedback_url nil,
         :title        "Registrations",
         :is_break     false,
         :id           22,
      ...
      {:sessions
       [{:description  {:html "", :text ""},
         :timezone     "Asia/Kolkata",
         :proposal_url nil,
         :start_at     "2020-02-15T09:30:00+05:30",
         :end_at       "2020-02-15T09:40:00+05:30",
         :feedback_url nil,
         :title
      ...
      {:sessions
       [{:description
         ...
         :start_at    "2020-02-15T09:40:00+05:30",
         :end_at      "2020-02-15T10:30:00+05:30",
         :feedback_url
      ...
      {:sessions
       [{:description
         ...
         :start_at    "2020-02-15T10:30:00+05:30",
         :end_at      "2020-02-15T11:15:00+05:30",
         :feedback_url
      ...
      {:sessions
       [{:description  {:html "", :text ""},
         :timezone     "Asia/Kolkata",
         :proposal_url nil,
         :start_at     "2020-02-15T11:15:00+05:30",
         :end_at       "2020-02-15T11:45:00+05:30",
         :feedback_url nil,
         :title        "Tea / Coffee",
         :is_break     true,
         :id           26,
      ...
      {:sessions
       [{:description
         ...
         :start_at    "2020-02-15T11:45:00+05:30",
         :end_at      "2020-02-15T12:05:00+05:30",
         :feedback_url
      ...
      {:sessions
       [{:description
         ...
         :start_at    "2020-02-15T12:05:00+05:30",
         :end_at      "2020-02-15T12:50:00+05:30",
         :feedback_url
      ...
      {:sessions
       [{:description
         ...
         :start_at    "2020-02-15T12:50:00+05:30",
         :end_at      "2020-02-15T13:35:00+05:30",
         :feedback_url
      ...
      {:sessions
       [{:description  {:html "", :text ""},
         :timezone     "Asia/Kolkata",
         :proposal_url nil,
         :start_at     "2020-02-15T13:35:00+05:30",
         :end_at       "2020-02-15T14:30:00+05:30",
         :feedback_url nil,
         :title        "Lunch",
         :is_break     true,
         :id           29,
      ...
      {:sessions
       [{:description
         ...
         :start_at    "2020-02-15T14:30:00+05:30",
         :end_at      "2020-02-15T15:15:00+05:30",
         :feedback_url
      ...
      {:sessions
       [{:description
         ...
         :start_at    "2020-02-15T15:15:00+05:30",
         :end_at      "2020-02-15T15:40:00+05:30",
         :feedback_url
      ...
      {:sessions
       [{:description  {:html "", :text ""},
         :timezone     "Asia/Kolkata",
         :proposal_url nil,
         :start_at     "2020-02-15T15:40:00+05:30",
         :end_at       "2020-02-15T16:10:00+05:30",
         :feedback_url nil,
         :title        "Tea / Coffee",
         :is_break     true,
         :id           33,
      ...
      {:sessions
       [{:description
         {:html
          "<p>I will briefly cover <strong>Meta 101</strong>,  followed by discussing the following topics in terms of how <code>meta</code> can empower a developer in each of the areas:</p>\n<ul>\n<li>Dev-tools</li>\n<li>Compiler hints</li>\n<li>Testing</li>\n<li>Documentation (Not just docstrings)</li>\n<li>Readability and Reasonability</li>\n</ul>",
          :text
         ...
         :timezone    "Asia/Kolkata",
         :proposal_url
         "https://hasgeek.com/inclojure/2020/proposals/the-power-of-meta-jR45cUFsqZV2iLpGpPorRg",
         :start_at    "2020-02-15T16:10:00+05:30",
         :end_at      "2020-02-15T16:35:00+05:30",
         :feedback_url
         "https://hasgeek.com/inclojure/2020/schedule/the-power-of-meta-BJTdo8xhBquj6WznoZETPo/feedback",
         :title       "The power of meta",
         :is_break    false,
         :id          44,
         :json_url
         "https://hasgeek.com/inclojure/2020/proposals/the-power-of-meta-jR45cUFsqZV2iLpGpPorRg/json",
         :url_name_suuid
         "the-power-of-meta-BJTdo8xhBquj6WznoZETPo",
         :url_name    "44-the-power-of-meta",
         :url
         "https://hasgeek.com/inclojure/2020/schedule/the-power-of-meta-BJTdo8xhBquj6WznoZETPo",
         :room
         "novotel-pune-nagar-road-crimson-hall/crimson-hall-day-of-talks-at-novotel-hotel",
         :proposal    "jR45cUFsqZV2iLpGpPorRg",
         :proposal_id 5246,
         :speaker     "Amarjeet Yadav",
         :speaker_bio
         {:html
          "<p>I am a Clojure developer at Ventur8. I work on language design and implementation, and distributed platforms. At Ventur8, we are building a programming language and its support systems (such as runtime, platforms, and dev-tools), which help developers focus on writing just business logic, and not worry about non-essential aspects such as DevOps.</p>",
          :text
      ...
      {:sessions
       [{:description
         ...
         :end_at      "2020-02-15T16:45:00+05:30",
         :feedback_url
      ...
      {:sessions
       [{:description
         ...
         :start_at    "2020-02-15T16:45:00+05:30",
         :end_at      "2020-02-15T17:05:00+05:30",
         :feedback_url
      ...
      {:sessions
       [{:description
         ...
         :start_at    "2020-02-15T17:05:00+05:30",
         :end_at      "2020-02-15T17:15:00+05:30",
         :feedback_url
      ...
      {:sessions
       [{:description
         ...
         :start_at    "2020-02-15T17:15:00+05:30",
      ...
      {:sessions
       [{:description
         ...
         :timezone     "Asia/Kolkata",
         :proposal_url nil,
         :start_at     "2020-02-15T18:00:00+05:30",
         :end_at       "2020-02-15T19:00:00+05:30",
         :feedback_url nil,
